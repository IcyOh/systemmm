...
client.on("ready", () => {
  ...
  client.user.setActivity(`${prefix}help | K-System`, { type: "WATCHING" });
});
...
client.on("message", message => {
  if (message.content.toLowerCase() === prefix + "help") {
    ...
    let help = new Discord.MessageEmbed()
      ...
      .addField(
        `General`,
        `> **${prefix}user ${prefix}server ${prefix}avatar ${prefix}roles ${prefix}emojis ${prefix}ping ${prefix}find ${prefix}discrim**`,
        true
      )
      .addField(
        `Moderation`,
        `> **${prefix}kick ${prefix}ban ${prefix}unban ${prefix}mute ${prefix}unmute ${prefix}lock ${prefix}unlock ${prefix}clear ${prefix}nick ${prefix}move ${prefix}set-stayvoice ${prefix}stayvoice**`,
        true
      )
      .addField(
        `Ticket`,
        `> **${prefix}new ${prefix}add ${prefix}remove ${prefix}rename ${prefix}close**`,
        true
      )
...
.setTitle(`Command: Limts-PROTECTION `)
...
client.on('message', message => {
if(message.author.bot) return undefined;
 if (message.content.startsWith(prefix + 'kick') || message.content.startsWith('حظر')){
